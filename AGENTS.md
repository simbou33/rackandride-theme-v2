...
- **Phase 2 — Page produit :** carousel images ; **ordre** = titre/prix/variant/qté → USP → short description → ATC/Buy now → bandeau réassurance → accordéons (**Matériaux / Livraison & Retours / Dimensions / Entretien**) → `hr` → description longue ; **sticky ATC** ; JSON-LD.
